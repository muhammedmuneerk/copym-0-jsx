    ...
    <div className="bg-gradient-to-r from-black via-gray-900 to-black min-h-screen text-white">
      ...
      <div className="container mx-auto px-6 py-8 flex items-center gap-4 mt-20">
        ...
        <div className="flex-grow">
          <h1 className="text-4xl font-bold tracking-wider font-tech">Carbon Credits Tokenization</h1>
          <p className="text-gray-400 mt-1">Democratize Environmental Investment</p>
        </div>
      ...
      <div className="container mx-auto px-6 py-16">
        {/* Hero Section */}
        <h2 className="text-4xl font-bold text-green-400 mb-16 font-tech">Revolutionize Environmental Investment</h2>
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-12 lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-gray-900/80 rounded-xl p-6 border border-gray-800">
              ...
              <p className="text-gray-400">Direct investment in carbon offset and sustainability projects</p>
            </div>
            ...
            <div className="bg-gray-900/80 rounded-xl p-6 border border-gray-800">
              ...
              <p className="text-gray-400">Trade carbon credits across international markets</p>
            </div>
            ...
            <div className="bg-gray-900/80 rounded-xl p-6 border border-gray-800 md:col-span-2 lg:col-span-1">
              ...
              <p className="text-gray-400">Blockchain-verified carbon credit authenticity and tracking</p>
            </div>
          </div>
          ...
          <div className="col-span-12 lg:col-span-5">
            <div className="bg-gradient-to-br from-teal-900 to-green-900 rounded-xl p-6">
              <h3 className="text-2xl font-bold text-teal-300 mb-6 font-tech">Tokenizable Carbon Credit Types</h3>
      ...
      <div className="bg-black py-16">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-4xl font-bold mb-4 font-tech">Ready to Make a Sustainable Impact?</h2>
          <p className="text-gray-400 max-w-2xl mx-auto mb-12">
            Join the future of environmental investment by tokenizing carbon credits and supporting global sustainability efforts.
          </p>
