    ...
    <div className="bg-gradient-to-r from-black via-gray-900 to-black min-h-screen text-white">
      ...
      <div className="container mx-auto px-6 py-8 flex items-center gap-4 mt-20">
        ...
        <div className="flex-grow">
          <h1 className="text-4xl font-bold tracking-wider font-tech">Diverse Asset Tokenization</h1>
          <p className="text-gray-400 mt-1">Tokenize Beyond Traditional Boundaries</p>
        </div>
      ...
      <div className="container mx-auto px-6 py-16">
        {/* Hero Section */}
        <h2 className="text-4xl font-bold text-blue-400 mb-16 font-tech">Unlimited Tokenization Possibilities</h2>
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-12 lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-gray-900/80 rounded-xl p-6 border border-gray-800">
              <div className="mb-4">
                <AutoAwesomeMotionIcon className="text-blue-400" fontSize="large" />
              </div>
              <h3 className="text-xl font-bold mb-2">Flexible Tokenization</h3>
              <p className="text-gray-400">Tokenize virtually any asset with unique blockchain solutions</p>
            </div>
            ...
            <div className="bg-gray-900/80 rounded-xl p-6 border border-gray-800">
              ...
              <p className="text-gray-400">Open up new investment opportunities across diverse asset types</p>
            </div>
            ...
            <div className="bg-gray-900/80 rounded-xl p-6 border border-gray-800 md:col-span-2 lg:col-span-1">
              ...
              <h3 className="text-xl font-bold mb-2">Comprehensive Compliance</h3>
              <p className="text-gray-400">Robust legal and regulatory frameworks for diverse </p>
            </div>
          </div>
          ...
          <div className="col-span-12 lg:col-span-5">
            <div className="bg-gradient-to-r from-black via-gray-900 to-black rounded-xl p-6">
              <h3 className="text-2xl font-bold mb-6 font-tech">Innovative Asset Types</h3>
      ...
      <div className="bg-black py-16">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-4xl font-bold mb-4 font-tech">Can't find your asset type?</h2>
