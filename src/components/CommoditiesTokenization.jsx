  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white mt-20">
      ...
      <section className="px-8 py-16 md:px-16 lg:px-24">
        <h1 className="text-4xl md:text-5xl font-bold mb-2">Commodities Tokenization</h1>
        <h2 className="text-xl md:text-2xl text-gray-300 mb-4">Transforming Physical Assets into Digital Investments</h2>
        <p className="text-gray-400 mb-8 max-w-2xl">
          Unlock new investment opportunities in global commodity markets through blockchain technology
        </p>
        <div className="flex flex-wrap gap-4">
          ...
          <Button 
            ...
            style={{ borderColor: '#6B7280', color: 'white', textTransform: 'none' }}
          >
      ...
      <section className="px-8 py-16 md:px-16 lg:px-24 flex flex-col md:flex-row">
        <div className="md:w-1/2">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Redefine Commodity Investment</h2>
          <p className="text-gray-400 mb-8">
            Leverage blockchain technology to transform traditional commodity investing
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-gray-800/50 border border-gray-700 p-6 rounded-lg">
              ...
              <h3 className="text-xl font-medium mb-2 text-gray-200">Commodity Liquidity</h3>
            ...
            <div className="bg-gray-800/50 border border-gray-700 p-6 rounded-lg">
              ...
              <h3 className="text-xl font-medium mb-2 text-gray-200">Risk Mitigation</h3>
              <p className="text-gray-400">
            ...
            <div className="bg-gray-800/50 border border-gray-700 p-6 rounded-lg ">
              ...
              <h3 className="text-xl font-medium mb-2 text-gray-200">Global Access</h3>
              <p className="text-gray-400">
          ...
          <Card className="bg-gray-800 text-white rounded-lg overflow-hidden shadow-xl">
            ...
            <div className="bg-green-600 p-6 relative">
              <div className="flex justify-between items-center">
                <IconButton size="small" className="text-white absolute left-4 bg-white/20 hover:bg-white/30 w-8 h-8">
                ...
                <div className="flex items-center">
                  <div className="mr-8">
                    <svg width="40" height="40" viewBox="0 0 40 40" className="text-white/80">
                      <rect x="8" y="8" width="24" height="6" fill="currentColor" opacity="0.7" />
                      <rect x="8" y="17" width="24" height="6" fill="currentColor" opacity="0.8" />
                      <rect x="8" y="26" width="24" height="6" fill="currentColor" opacity="0.9" />
                    </svg>
                  </div>
                  <IconButton size="small" className="text-white absolute right-4 bg-white/20 hover:bg-white/30 w-8 h-8">
              ...
              <div className="grid grid-cols-3 gap-4 mb-6">
                <div>
                  ...
                  <p className="text-xl font-semibold flex items-center">
                    <span className="inline-block w-5 h-5 mr-1 rounded-full bg-green-500 flex items-center justify-center text-xs">$</span>
                    15.6M
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-xl font-semibold flex items-center">
                    <span className="inline-block w-5 h-5 mr-1 rounded-full bg-blue-500 flex items-center justify-center text-xs">↗</span>
                    156,000
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-xl font-semibold flex items-center">
                    <span className="inline-block w-5 h-5 mr-1 rounded-full bg-purple-500 flex items-center justify-center text-xs">★</span>
                    520
                  </p>
                </div>
              </div>
              ...
              <div className="mb-6">
                <div className="flex justify-between mb-1">
                  ...
                  <span className="text-right">
                    <span className="text-gray-400 text-sm">Token Price</span><br />
                ...
                <div className="grid grid-cols-10 gap-1 mb-2">
                  {Array(10).fill(0).map((_, i) => (
                    <div key={`row1-${i}`} className="h-4 bg-green-500 rounded-sm"></div>
                  ))}
                  {Array(10).fill(0).map((_, i) => (
                    <div key={`row1-${i}`} className="h-4 bg-green-500 rounded-sm"></div>
                  ))}
                 ...
                 {Array(10).fill(0).map((_, i) => (
                    <div key={`row1-empty-${i}`} className="h-4 bg-gray-600 rounded-sm"></div>
                  ))}
                 {Array(10).fill(0).map((_, i) => (
                    <div key={`row1-empty-${i}`} className="h-4 bg-gray-600 rounded-sm"></div>
                  ))}
                  ...
                  {Array(8).fill(0).map((_, i) => (
                    <div key={`row2-empty-${i}`} className="h-4 bg-gray-600 rounded-sm"></div>
                  ))}
                </div>
      ...
      <section className="px-8 py-16 md:px-16 lg:px-24 text-center">
        <h2 className="text-3xl md:text-4xl font-bold mb-2">
          Benefits of <span className="text-green-500">Commodity Tokenization</span>
        </h2>
        <p className="text-gray-400 mb-12 max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-gray-800 rounded-lg p-8">
            <h3 className="text-xl text-green-500 font-semibold mb-6 text-left">For Investors</h3>
          ...
          <div className="bg-gray-800 rounded-lg p-8">
            <h3 className="text-xl text-green-500 font-semibold mb-6 text-left">For Commodity Owners</h3>
            <ul className="space-y-4 text-left">
              <li className="flex items-center">
                <span className="text-green-500 mr-3">✓</span>
      ...
      <section className="px-8 py-16 md:px-16 lg:px-24 text-center">
        ...
        <p className="text-gray-400 mb-8 max-w-3xl mx-auto">
          Join the future of commodity investing with our blockchain-powered tokenization platform
        </p>
