          ...
          >
            ...
            >
              ...
              <Box component="span" className="block">
                <Box
                  component="span"
                  className="bg-[linear-gradient(183deg,_rgba(19,225,0,1)_0%,_rgba(0,0,0,1)_0%,_rgba(6,75,0,1)_9%,_rgba(18,240,0,1)_62%,_rgba(0,0,0,1)_100%)] bg-clip-text text-transparent"
                >
                  Real World Asset
                </Box>{" "}
                Tokenization
