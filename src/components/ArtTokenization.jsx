  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <Typography variant="h5" className="text-xl md:text-2xl font-medium mb-4">
          Democratizing Art Investment
        </Typography>
        <Typography variant="body1" className="text-gray-300 mb-8 max-w-2xl">
          Transform art ownership through blockchain technology, making valuable art accessible to global investors
        </Typography>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            <Typography variant="h3" className="text-3xl md:text-4xl font-bold mb-4">
          ...
          <div className="bg-gray-800 rounded-lg overflow-hidden border border-gray-700">
            ...
            <div className="relative bg-gradient-to-r from-green-500 to-green-700 p-8">
              <div className="absolute top-4 left-4">
                <IconButton size="small" className="bg-gray-800 text-white mr-2">
            ...
            <div className="p-6">
              <div className="grid grid-cols-3 gap-4 mb-6">
                <div>
                  ...
                  <Typography variant="h6" className="font-bold flex items-center">
                    <Box component="span" className="text-green-500 mr-1">$</Box>1.2M
                  </Typography>
                </div>
                <div>
                  <Typography variant="body2" className="text-gray-400 mb-1">
                  ...
                  <Typography variant="h6" className="font-bold flex items-center">
                    <Box component="span" className="text-green-500 mr-1">#</Box>12,000
                  </Typography>
                </div>
                <div>
                  <Typography variant="body2" className="text-gray-400 mb-1">
                  ...
                  <Typography variant="h6" className="font-bold flex items-center">
                    <Box component="span" className="text-green-500 mr-1">👤</Box>420
                  </Typography>
                </div>
              </div>
              ...
              <div className="mb-6">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <Typography variant="body2" className="text-right">
                    Token Price
                    <Typography variant="h6" className="font-bold">${100}</Typography>
                  </Typography>
                </div>
                ...
                <div className="grid grid-cols-10 gap-1 mb-2">
                  {[...Array(100)].map((_, index) => (
                    <div 
                      key={index} 
                      className={`h-2 rounded-sm ${index < 75 ? 'bg-green-500' : 'bg-gray-600'}`}
                    />
                  ))}
                </div>
              ...
              <div className="border-t border-gray-700 pt-4">
                <Button 
                  ...
                  endIcon={<ExpandMoreIcon className={artworkDetails ? "transform rotate-180" : ""} />}
                >
                  Artwork Details
                </Button>
