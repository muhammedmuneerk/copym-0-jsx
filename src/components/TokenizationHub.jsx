...
export default function TokenizationHub() {
  ...
  const handleNext = () => {
    setActiveStep((prevStep) => Math.min(prevStep + 1, tokenizationSteps.length - 1));
  };
  ...
  return (
    <Box 
      ...
      sx={{
        background: 'linear-gradient(180deg, rgba(0,0,0,0.9) 0%, rgba(18,19,26,1) 100%)',
        pt: 16,
        pb: 8,
        position: 'relative',
        '&::before': {
          ...
          right: 0,
          height: '100%',
          background: 'radial-gradient(circle at 50% 0%, rgba(0,255,133,0.15) 0%, rgba(0,0,0,0) 50%)',
          pointerEvents: 'none',
        }
      }}
    >
      <Container maxWidth="xl">
        ...
        >
          ...
          >
            Transform any real-world asset into digital tokens with CopyM's comprehensive
        ...
        <Box className="mb-32">
          ...
          >
            Our unified platform supports the complete tokenization lifecycle for all major
            asset classes
          </Typography>
                          ...
                          <ListItem key={i} className="px-0">
                            <ListItemIcon sx={{ minWidth: 32 }}>
                              <CheckIcon 
                                ...
                                fontSize="small"
                                sx={{ filter: 'drop-shadow(0 0 5px rgba(0, 255, 133, 0.5))' }}
                              />
                            </ListItemIcon>
                            <ListItemText
                              primary={benefit}
        ...
        <Box className="mb-32 relative">
          <Box
            sx={{
              ...
              width: '100%',
              height: '200%',
              background: 'radial-gradient(circle at 50% 0%, rgba(0,255,133,0.1) 0%, rgba(0,0,0,0) 50%)',
              pointerEvents: 'none',
            }}
          />
          <Typography
          ...
          <Typography
            ...
            className="text-text-secondary text-center max-w-2xl mx-auto mb-16 text-lg"
          >
            CopyM guides you through every step of the tokenization process with our
    ...
    {tokenizationSteps.map((step, index) => (
      <Step key={step.label}>
            ...
            >
              <Box className="flex items-start gap-6">
                <Box className="flex-1">
                  ...
                  >
                    {tokenizationSteps[activeStep].features.map((feature, index) => (
                      <motion.div
                        key={index}
                ...
                >
                  <IconButton
                    ...
                    sx={{
                      ...
                      color: activeStep === 0 ? 'rgba(255, 255, 255, 0.2)' : 'rgba(255, 255, 255, 0.7)',
                      '&:hover': {
                        backgroundColor: 'rgba(0, 255, 133, 0.1)',
                        color: '#00ff85',
                      },
                  ...
                  <IconButton
                    ...
                    sx={{
                      ...
                      height: 40,
                      backgroundColor: 'rgba(255, 255, 255, 0.05)',
                      color: activeStep === tokenizationSteps.length - 1 
        ...
        <Box className="mb-32">
          ...
          >
            Why Choose{' '}
            <span className="text-primary">CopyM</span>
          </Typography>
          <Typography
            variant="body1"
            className="text-text-secondary text-center max-w-2xl mx-auto mb-16 text-lg"
          ...
          <Card
            sx={{
              ...
              '&::after': {
                ...
                width: '30%',
                height: '100%',
                background: 'linear-gradient(45deg, rgba(0,255,133,0) 0%, rgba(0,255,133,0.1) 100%)',
                pointerEvents: 'none',
              },
            }}
          >
            ...
            <Typography variant="body1" className="text-text-secondary">
              CopyM provides end-to-end tokenization infrastructure in one platform, eliminating the need
              to piece together multiple services.
            </Typography>
          </Card>
        </Box>
          ...
          <Card
            sx={{
              ...
              '&::before': {
                ...
                width: '100%',
                height: '100%',
                background: 'radial-gradient(circle at top right, rgba(0,255,133,0.1) 0%, rgba(0,0,0,0) 70%)',
                pointerEvents: 'none',
              },
            }}
          >
                ...
                <Grid container key={row.feature} className="py-2">
                  ...
                  <Grid item xs={3}>
                    <Box className="flex items-center gap-2">
                      ...
                      <Typography variant="body2">{row.competitorA.value}</Typography>
                    </Box>
                  </Grid>
                  <Grid item xs={3}>
                    <Box className="flex items-center gap-2">
                      <CancelIcon color="error" />
                      <Typography variant="body2">{row.competitorB.value}</Typography>
                    </Box>
                  </Grid>
                </Grid>
              ))}
        ...
        <Box className="text-center relative">
          ...
          >
            ...
            >
              Join thousands of businesses and investors already transforming their assets on
              the CopyM platform.
            </Typography>
            <Button
              variant="contained"
