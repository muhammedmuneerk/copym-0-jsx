    ...
    <div className="bg-[#0f172a] text-white min-h-screen">
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mt-20">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Real Estate Tokenization</h1>
          <h2 className="text-xl md:text-2xl font-medium mb-4">Transform Property Investment with Blockchain Technology</h2>
          <p className="text-gray-300 mb-8">
            Democratize real estate investment through fractional ownership, enhanced liquidity, and global accessibility.
          </p>
          <div className="flex flex-wrap gap-4">
            ...
            <Button 
              ...
              style={{ borderColor: '#10b981', color: '#10b981', textTransform: 'none' }}
            >
              Learn More
            </Button>
          </div>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Revolutionize Real Estate Investment</h2>
            <p className="text-gray-300 mb-8">
              Copym enables investors to tokenize and trade real estate assets with unprecedented ease, transparency, and efficiency.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <CardContent className="p-6">
                  <div className="flex mb-4">
                    <Box className="w-12 h-12 bg-opacity-20 bg-green-900 rounded-md flex items-center justify-center">
                      <BusinessIcon style={{ color: '#10b981', fontSize: 28 }} />
                    </Box>
                  </div>
                  ...
                  <Typography variant="body2" className="text-gray-400">
                    Invest in premium real estate with lower entry barriers and increased liquidity.
                  </Typography>
                </CardContent>
              </Card>
              ...
              <Card className="bg-[#1e293b] text-white border-none h-full rounded-lg overflow-hidden">
                <CardContent className="p-6">
                  <div className="flex mb-4">
                    <Box className="w-12 h-12 bg-opacity-20 bg-green-900 rounded-md flex items-center justify-center">
                      <DescriptionIcon style={{ color: '#10b981', fontSize: 28 }} />
                    </Box>
                  </div>
                  <Typography variant="h6" className="mb-2 font-bold">
                    Dynamic Valuation
                  ...
                  <Typography variant="body2" className="text-gray-400">
                    Real-time market pricing and transparent asset valuation through blockchain.
                  </Typography>
                </CardContent>
              </Card>
              ...
              <Card className="bg-[#1e293b] text-white border-none h-full rounded-lg overflow-hidden">
                <CardContent className="p-6">
                  ...
                  <Typography variant="body2" className="text-gray-400">
                    Automated regulatory checks and investor verification for seamless transactions.
                  </Typography>
                </CardContent>
              </Card>
              ...
              <Card className="bg-[#1e293b] text-white border-none h-full rounded-lg overflow-hidden">
                <CardContent className="p-6">
                  ...
                  <Typography variant="body2" className="text-gray-400">
                    Trade and invest in international real estate markets without geographical limitations.
                  </Typography>
                </CardContent>
              </Card>
            </div>
                          ...
                          <div className="bg-gradient-to-r from-blue-600 to-blue-700 p-6">
                            <div className="flex justify-between items-center">
                              <div>
                                ...
                                <p className="text-gray-300">New York, USA • Commercial</p>
                              </div>
                              <div className="flex">
                              ...
                              <div className="bg-gray-700 -mt-4 mb-4 p-4 rounded-b-md">
                                ...
                                <div>
                                  ...
                                  <ul className="space-y-2">
                                    ...
                                    <li className="flex items-start">
                                      <span className="text-blue-500 mr-2">→</span>
                                      <span className="text-gray-200">Secondary market trading for liquidity</span>
                                    </li>
                                    <li className="flex items-start">
                                      <span className="text-blue-500 mr-2">→</span>
                                      <span className="text-gray-200">Automated dividend distributions</span>
                                    </li>
                                    <li className="flex items-start">
                                      <span className="text-blue-500 mr-2">→</span>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-2">
            Real Estate <span className="text-green-500">Tokenization Process</span>
          </h2>
          <p className="text-gray-300">
            Our streamlined process makes tokenizing real estate assets simple and efficient
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card className="bg-[#1e293b] text-white h-full relative">
            ...
            <CardContent className="pt-16 pb-8">
              ...
              <Typography variant="body2" className="text-gray-400">
                Register property details, documentation, and ownership verification.
              </Typography>
            </CardContent>
          </Card>
          ...
          <Card className="bg-[#1e293b] text-white h-full relative">
            ...
            <CardContent className="pt-16 pb-8">
              ...
              <Typography variant="body2" className="text-gray-400">
                Set up the appropriate legal framework based on jurisdiction and property type.
              </Typography>
            </CardContent>
          </Card>
          ...
          <Card className="bg-[#1e293b] text-white h-full relative">
            ...
            <CardContent className="pt-16 pb-8">
              ...
              <Typography variant="body2" className="text-gray-400">
                Create property tokens with compliance and regulatory parameters built-in.
              </Typography>
            </CardContent>
          </Card>
          ...
          <Card className="bg-[#1e293b] text-white h-full relative">
            ...
            <CardContent className="pt-16 pb-8">
              ...
              <Typography variant="body2" className="text-gray-400">
                Enable primary offering and secondary market trading for property tokens.
              </Typography>
            </CardContent>
          </Card>
        </div>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-2">
            Benefits of <span className="text-green-500">Real Estate Tokenization</span>
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <Card className="bg-[#1e293b] text-white h-full">
            <CardContent className="p-8">
              <Typography variant="h5" className="font-bold mb-6 text-green-500">
                For Property Owners
              </Typography>
      ...
      <section className="container mx-auto px-4 py-16 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-gray-300 mb-8">
            Join thousands of property owners and investors already tokenizing real estate on the Copym platform.
          </p>
